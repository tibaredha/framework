...
"c"           => $ctrl,
"m"           => $mdl,
"combo"       => array("Nom"=>'NOM',"id"=>'id',"prenom"=>'PRENOM',"Sexe"=>'SEX'),
"submitvalue" => 'Search',
...
<?php
		...
		echo '<br>';
		echo'<table>';
			echo'<tr bgcolor="#00CED1"><th colspan="'.$colspan.'" ><A HREF="'.URL.$ctrl.'/'.$mdl.'/'.$urlx[2].'/'.$urlx[3].'?o=NOM&q="> La liste des certificats de décès </A> : <span>'.$total_count1.'/'.$total_count.' enregistrement(s) trouvé(s)</span></th></tr>';
			...
			{
				echo '<td align="center" style="width:10px;" bgcolor="#32CD32" ><a target="_blank" title="Certificat de décès périnatal"  href="'.URL.$ctrl.'/decesperinatal/'.$value['id'].'" ><img src="'.URL.'public/images/b_props.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			} 
