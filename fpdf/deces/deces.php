...
{ 
	...
	function valeur($DATEJOUR1,$DATEJOUR2,$STRUCTURED,$SEX) 
	{
	$this->mysqlconnect();
	$sql = " select * from deceshosp  where DINS BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' and  STRUCTURED $STRUCTURED  AND SEX	$SEX";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function valeurpm($EPH1,$ANNEE) 
	{
	  
		$SEXM='='.'"M"';$SEXF='='.'"F"';$SEX='IS NOT NULL';
		
		$Janm = $this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$EPH1,$SEXM);$Janf = $this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$EPH1,$SEXF);$Jan =$this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$EPH1,$SEX);
		$Fevm = $this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$EPH1,$SEXM);$Fevf = $this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$EPH1,$SEXF);$Fev =$this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$EPH1,$SEX);
		$Marm = $this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$EPH1,$SEXM);$Marf = $this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$EPH1,$SEXF);$Mar =$this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$EPH1,$SEX);
		$Avrm = $this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$EPH1,$SEXM);$Avrf = $this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$EPH1,$SEXF);$Avr =$this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$EPH1,$SEX);
		$Maim = $this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$EPH1,$SEXM);$Maif = $this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$EPH1,$SEXF);$Mai =$this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$EPH1,$SEX);
		$Juim = $this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$EPH1,$SEXM);$Juif = $this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$EPH1,$SEXF);$Jui =$this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$EPH1,$SEX);
		$Juilm= $this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$EPH1,$SEXM);$Juilf= $this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$EPH1,$SEXF);$Juil=$this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$EPH1,$SEX);
		$Aoum = $this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$EPH1,$SEXM);$Aouf = $this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$EPH1,$SEXF);$Aou =$this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$EPH1,$SEX);
		$Sepm = $this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$EPH1,$SEXM);$Sepf = $this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$EPH1,$SEXF);$Sep =$this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$EPH1,$SEX);
		$Octm = $this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$EPH1,$SEXM);$Octf = $this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$EPH1,$SEXF);$Oct =$this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$EPH1,$SEX);
		$Novm = $this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$EPH1,$SEXM);$Novf = $this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$EPH1,$SEXF);$Nov =$this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$EPH1,$SEX);
		$Decm = $this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$EPH1,$SEXM);$Decf = $this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$EPH1,$SEXF);$Dec =$this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$EPH1,$SEX);
		
		$this->SetXY(5,$this->GetY()+10);$this->cell(35,5,"Année ".$ANNEE,1,0,'C',1,0);$this->cell(20,5,"M",1,0,'C',1,0);  $this->cell(20,5,"F",1,0,'C',1,0);   $this->cell(20,5,"T",1,0,'C',1,0);$this->SetXY($this->GetX()+5,$this->GetY());$this->cell(100,5,"",1,0,'L',1,0);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Jan",1,0,'C',1,0); $this->cell(20,5,$Janm ,1,0,'C',0,0); $this->cell(20,5,$Janf ,1,0,'C',0,0); $this->cell(20,5,$Jan ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Jan!=0){$this->cell($Jan,5,$Jan ,1,0,'L',1,0);}else {$this->cell(0.19,5,$Jan ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Fev",1,0,'C',1,0); $this->cell(20,5,$Fevm ,1,0,'C',0,0); $this->cell(20,5,$Fevf,1,0,'C',0,0);  $this->cell(20,5,$Fev,1,0,'C',1,0);  $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Fev!=0){$this->cell($Fev,5,$Fev ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Fev ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Mar",1,0,'C',1,0); $this->cell(20,5,$Marm ,1,0,'C',0,0); $this->cell(20,5,$Marf ,1,0,'C',0,0); $this->cell(20,5,$Mar,1,0,'C',1,0);  $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Mar!=0){$this->cell($Mar,5,$Mar ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Mar ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Avr",1,0,'C',1,0); $this->cell(20,5,$Avrm ,1,0,'C',0,0); $this->cell(20,5,$Avrf ,1,0,'C',0,0); $this->cell(20,5,$Avr ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Avr!=0){$this->cell($Avr,5,$Avr ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Avr ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Mai",1,0,'C',1,0); $this->cell(20,5,$Maim ,1,0,'C',0,0); $this->cell(20,5,$Maif ,1,0,'C',0,0); $this->cell(20,5,$Mai ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Mai!=0){$this->cell($Mai,5,$Mai ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Mai ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Jui",1,0,'C',1,0); $this->cell(20,5,$Juim ,1,0,'C',0,0); $this->cell(20,5,$Juif ,1,0,'C',0,0); $this->cell(20,5,$Jui ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Jui!=0){$this->cell($Jui,5,$Jui ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Jui ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Jui",1,0,'C',1,0); $this->cell(20,5,$Juilm ,1,0,'C',0,0);$this->cell(20,5,$Juilf ,1,0,'C',0,0);$this->cell(20,5,$Juil ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Juil!=0){$this->cell($Juil,5,$Juil ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Juil ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Aou",1,0,'C',1,0); $this->cell(20,5,$Aoum ,1,0,'C',0,0); $this->cell(20,5,$Aouf ,1,0,'C',0,0); $this->cell(20,5,$Aou,1,0,'C',1,0);  $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Aou!=0){$this->cell($Aou,5,$Aou,1,0,'L',1,0);}else{$this->cell(0.19,5,$Aou,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Sep",1,0,'C',1,0); $this->cell(20,5,$Sepm ,1,0,'C',0,0); $this->cell(20,5,$Sepf ,1,0,'C',0,0); $this->cell(20,5,$Sep ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Sep!=0){$this->cell($Sep,5,$Sep ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Sep ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Oct",1,0,'C',1,0); $this->cell(20,5,$Octm ,1,0,'C',0,0); $this->cell(20,5,$Octf ,1,0,'C',0,0); $this->cell(20,5,$Oct ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Sep!=0){$this->cell($Oct,5,$Oct ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Oct ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Nov",1,0,'C',1,0); $this->cell(20,5,$Novm ,1,0,'C',0,0);$this->cell(20,5,$Novf ,1,0,'C',0,0);  $this->cell(20,5,$Nov ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Nov!=0){$this->cell($Nov,5,$Nov ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Nov ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Dec",1,0,'C',1,0); $this->cell(20,5,$Decm ,1,0,'C',0,0);$this->cell(20,5,$Decf ,1,0,'C',0,0);  $this->cell(20,5,$Dec ,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Dec!=0){$this->cell($Dec,5,$Dec ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Dec ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(35,5,"Année ".$ANNEE,1,0,'C',1,0); $this->cell(20,5,$this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$EPH1,$SEXM) ,1,0,'C',0,0);$this->cell(20,5,$this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$EPH1,$SEXF) ,1,0,'C',0,0);$this->cell(20,5,$this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$EPH1,$SEX) ,1,0,'C',1,0);$this->SetXY($this->GetX()+5,$this->GetY());$this->cell(10,5,"10",1,0,'L',1,0);$this->cell(10,5,"20",1,0,'L',1,0);$this->cell(10,5,"30",1,0,'L',1,0);$this->cell(10,5,"40",1,0,'L',1,0);$this->cell(10,5,"50",1,0,'L',1,0);$this->cell(10,5,"60",1,0,'L',1,0);$this->cell(10,5,"70",1,0,'L',1,0);$this->cell(10,5,"80",1,0,'L',1,0);$this->cell(10,5,"90",1,0,'L',1,0);$this->cell(10,5,"100",1,0,'L',1,0);
	}	
	...
	function INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,$col)
	{
		$queryim= "SELECT * FROM deceshosp where $col='' and  DINS BETWEEN '$datejour1' AND '$datejour2' and STRUCTURED $STRUCTURED  order by  DINS  ";//
		$resultatim=mysql_query($queryim);
		$totalmbrim=mysql_num_rows($resultatim);
		if ($totalmbrim>0) 
		{
			$this->AddPage('L','A4');
			...
			$this->SetXY(5,$this->GetY()+10);$this->cell(290,5,"RELEVE DES CAUSES DE DECES (INFORMATION MANQUANTES) : ".$col,0,0,'C',0,0);
			...
			$this->cell(255,10,"Nom_Prénom",1,0,'C',1,0);
			$this->SetXY(05,$this->GetY()+10);
			$x=0;
			while($rowim=mysql_fetch_object($resultatim))
			{
			$this->cell(10,5,$x=$x+1,1,0,'C',0);
			$this->cell(20,5,$this->dateUS2FR($rowim->DINS),1,0,'C',0);
			$this->cell(255,5,trim($rowim->NOM).'_'.strtolower (trim($rowim->PRENOM)).' ['.strtolower (trim($rowim->FILSDE)).']'.'_('.$rowim->STRUCTURED.')',1,0,'L',0);
			$this->SetXY(5,$this->GetY()+5);
			}
			$this->SetXY(5,$this->GetY());
			$this->cell(285,05,"TOTAL : ".$totalmbrim,1,0,1,'C',0);
		}
	...
	function listedeces($STRUCTURED,$datejour1,$datejour2,$login,$type)
	{
		...
		{
			$x=$x+1;
			if ($row->aprouve=='0') {$this->SetFillColor(235);}else{$this->SetFillColor(255);}
			
			$this->cell(10,5,$x,1,0,'C',1,0);
			$this->cell(20,5,$this->dateUS2FR($row->DINS),1,0,'C',0,0);
			if ($type=='I') 
			{
			...
			else
			{
				...
				$this->cell(70,5,strtoupper (trim($row->NOM)).'_'.strtolower (trim($row->PRENOM)).' ['.strtolower (trim($row->FILSDE)).']',1,0,'L',0,0);
				$this->cell(10,5,trim($row->SEX),1,0,'C',0);
		...
		if ($totalmbrdb>0) 
		{
		 ...
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"NOM");
         $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"PRENOM");
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"FILSDE");
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"ETDE");
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"SEX");
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"DATENAISSANCE");
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"ADRESSE");
		 
		 $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"CIM1");
	     // $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"CIM2");
		 // $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"CIM3");
		 // $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"CIM4");
	     // $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"CIM5");
	     $this->INFORMATIONM($STRUCTURED,$datejour1,$datejour2,$login,$type,"MEDECINHOSPIT");
	
	
	    $querydbX= "SELECT COUNT(*) AS nbr_doublon,NOM,PRENOM,FILSDE,STRUCTURED,DINS,MEDECINHOSPIT FROM deceshosp  where STRUCTURED $STRUCTURED  GROUP BY MEDECINHOSPIT HAVING COUNT(*) > 1 ORDER BY nbr_doublon DESC ";//
		...
		if ($totalmbrdbX>0) 
		{
			...
			$this->SetXY(5,$this->GetY()+10);$this->cell(290,5,$this->dspfr.': '.$this->nbrtostring("wil","IDWIL",$this->nbrtostring("structure","id",$STRUCTUREDX[1],"idwil"),"WILAYAS"),0,0,'C',1,0);
			if($STRUCTURED =='IS NOT NULL'){$this->SetXY(5,$this->GetY()+15);$this->cell(90,5,"Service Prévention",0,0,'L',0,0);$this->SetXY(205,$this->GetY());$this->cell(90,5," LE : ".date('d-m-Y'),0,0,'C',0,0);$this->SetXY(5,$this->GetY()+5);$this->cell(90,5,"N ____ / ".date('Y'),0,0,'L',0,0);} else {$this->SetXY(5,$this->GetY()+15);$this->cell(90,5,$this->nbrtostring("structure","id",$STRUCTUREDX[1],"structure"),0,0,'L',0,0);$this->SetXY(205,$this->GetY());$this->cell(90,5," LE : ".date('d-m-Y'),0,0,'C',0,0);$this->SetXY(5,$this->GetY()+5);$this->cell(90,5,"SEMEP",0,0,'L',0,0);$this->SetXY(5,$this->GetY()+5);$this->cell(90,5,"N ____ / ".date('Y'),0,0,'L',0,0);}
			$this->SetXY(5,$this->GetY()+10);$this->cell(290,5,"RELEVE DES CAUSES DE DECES (MEDECINS)",0,0,'C',0,0);
			$this->SetXY(5,$this->GetY()+5);$this->cell(290,5,"Du  ".$this->dateUS2FR($datejour1)."  Au  ".$this->dateUS2FR($datejour2),0,0,'C',0,0);
			$this->SetXY(5,$this->GetY()+5);$this->cell(290,5,"Ref : Circulaire N° 607 du 24 septembre 1994  ",0,0,'C',0,0);
			$this->SetFillColor(200 );
			$this->SetXY(05,$this->GetY()+15);
			$this->cell(10,10,"N°",1,0,'C',1,0);
			$this->cell(265,10,"Nom_Prénom",1,0,'C',1,0);
			$this->cell(10,10,"Nbr",1,0,'C',1,0);
			$this->SetXY(05,$this->GetY()+10);
			$x=0;
			...
			{
			$this->cell(10,5,$x=$x+1,1,0,'C',0);
			$this->cell(265,5,$rowdbX->MEDECINHOSPIT,1,0,'L',0);
			// $this->cell(245,5,trim($rowdb->NOM).'_'.strtolower (trim($rowdb->PRENOM)).' ['.strtolower (trim($rowdb->FILSDE)).']'.'_('.$rowdb->STRUCTURED.')',1,0,'L',0);
			$this->cell(10,5,$rowdbX->nbr_doublon,1,0,'C',0);
			$this->SetXY(5,$this->GetY()+5);
			}
			$this->SetXY(5,$this->GetY());
			$this->cell(285,05,"TOTAL : ".$totalmbrdbX,1,0,1,'C',0);
		}
	...
	function IDCHAP($datejour1,$datejour2,$CODECIM0,$STRUCTURED,$SEX){
		$this->mysqlconnect();
		$sql = " select DINS,STRUCTURED,CODECIM0,SEX from deceshosp where SEX $SEX	and (DINS BETWEEN '$datejour1' AND '$datejour2') and ( STRUCTURED  $STRUCTURED ) and CODECIM0 $CODECIM0";
		$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	...
	{    
		$this->SetTextColor(0,0,0);$this->SetFillColor(230);$this->SetFont('Times', 'B', 10);
		$this->SetXY(5,25);$this->cell(200,5,$titre,1,0,'C',1,$link0);
		$this->SetXY(5,35);$this->cell(5,5,"C",1,0,'C',1,0);$this->cell(155,5,"Chapitre",1,0,'C',1,0);$this->cell(10,5,"M",1,0,'C',1,0);$this->cell(10,5,"F",1,0,'C',1,0);$this->cell(10,5,"T",1,0,'C',1,0);$this->cell(10,5,"%",1,0,'C',1,0);
		$this->SetXY(5,40);
		
		$totalmbr11M=$this->IDCHAP($datejour1,$datejour2,"IS NOT NULL",$EPH1,"='M'");
		$totalmbr11F=$this->IDCHAP($datejour1,$datejour2,"IS NOT NULL",$EPH1,"='F'");
		$totalmbr11=$this->IDCHAP($datejour1,$datejour2,"IS NOT NULL",$EPH1,"IS NOT NULL");
		...
		while($row=mysql_fetch_object($resultat))
		{
		    $nbr=$this->IDCHAP($datejour1,$datejour2,"=".$row->IDCHAP,$EPH1,"IS NOT NULL");
		    $nbrm=$this->IDCHAP($datejour1,$datejour2,"=".$row->IDCHAP,$EPH1,"='M'");
			$nbrf=$this->IDCHAP($datejour1,$datejour2,"=".$row->IDCHAP,$EPH1,"='F'");
			$this->SetFont('Times', '', 10);
			$this->cell(5,5,$row->IDCHAP,1,0,'C',0);
			$this->cell(155,5,$row->CHAP ,1,0,'L',0);
			$this->cell(10,5,$nbrm,1,0,'C',0);
			$this->cell(10,5,$nbrf,1,0,'C',0);
			$this->cell(10,5,$nbr,1,0,'C',0);
			if($totalmbr11 > 0){$this->cell(10,5,round(($nbr*100)/$totalmbr11,2),1,0,'C',0);} else {$this->cell(10,5,'0',1,0,'C',0);}
			$this->SetXY(5,$this->GetY()+5); 
		}	
		$this->SetXY(5,$this->GetY());$this->cell(5,5,"T",1,0,'C',1,0);	  
		$this->cell(155,5,($totalmbr1-1)." : Chapitres",1,0,'C',1,0);	  
		$this->cell(10,5,$totalmbr11M,1,0,'C',1,0);
		$this->cell(10,5,$totalmbr11F,1,0,'C',1,0);
		$this->cell(10,5,$totalmbr11,1,0,'C',1,0);	  
		if($totalmbr11 > 0){$this->cell(10,5,'100',1,0,'C',1,0); ;} else {$this->cell(10,5,'0',1,0,'C',1,0);}		
	}
	...
	{    
		$this->SetFont('Times', 'B', 10);
		$this->SetXY(5,25);$this->cell(200,5,$titre,1,0,'C',1,$link0);
		$this->SetXY(5,35);$this->cell(10,5,"Code",1,0,'C',1,0);$this->cell(145,5,"Categorie",1,0,'C',1,0);$this->cell(10,5,"M",1,0,'C',1,0);$this->cell(10,5,"F",1,0,'C',1,0);$this->cell(10,5,"T",1,0,'C',1,0);$this->cell(15,5,"P%",1,0,'C',1,0);
		$this->SetXY(5,40);
		...
		$query="SELECT CODECIM,count(CODECIM)as nbr,STRUCTURED,DINS FROM deceshosp where STRUCTURED $EPH1 and  DINS BETWEEN '$datejour1' AND '$datejour2' GROUP BY CODECIM  order by nbr desc ";          
		$resultat=mysql_query($query);
		$totalmbr1=mysql_num_rows($resultat);
		while($row=mysql_fetch_object($resultat))
		{
			...
			$this->cell(145,5,$this->nbrtostring('cim','row_id',$row->CODECIM,'diag_nom') ,1,0,'L',0);
			$this->cell(10,5,"*",1,0,'C',0);
			$this->cell(10,5,"*",1,0,'C',0);
		...
		$this->cell(145,5,$totalmbr1." : Categorie",1,0,'C',1,0);	  
		$this->cell(10,5,$totalmbr11M,1,0,'C',1,0);
		$this->cell(10,5,$totalmbr11F,1,0,'C',1,0);
		$this->cell(10,5,$totalmbr11,1,0,'C',1,0);	  
		$this->cell(15,5,'100%',1,0,'C',1,0);  
	...
	function DECESMATERNELS($datejour1,$datejour2,$EPH1,$STRUCTURED) 
	{
	$this->SetFont('Times', 'B', 11);$this->SetFillColor(200 );
	
	$this->SetXY(05,$this->GetY()+10);$this->cell(20,10,"Date Décés",1,0,1,'C',0);$this->cell(45,10,"Nom et Prenom ",1,0,1,'C',0);$this->cell(10,10,"Age",1,0,1,'C',0);$this->cell(125,10,"Cause du décés",1,0,1,'C',0);
	$this->SetXY(05,$this->GetY()+10); 
	...
	while($row=mysql_fetch_object($resultat))
	{
	$this->SetFont('Arial', '',9, '', true);$this->SetFillColor(200 );
	$this->cell(20,5,$this->dateUS2FR($row->DINS),1,0,'C',0);
	$this->cell(45,5,strtoupper ($row->NOM).'_'.$row->PRENOM,1,0,'L',0);
	...
	$this->cell(125,5,$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_nom'),1,0,'L',0);
	$this->SetXY(5,$this->GetY()+5); 
	}
	$this->SetFillColor(200 );
	$this->SetFont('Arial', '',10, '', true);  
	$this->SetXY(5,$this->GetY());$this->cell(40,05,"Total",1,0,1,'C',0);	  
	$this->SetXY(25,$this->GetY());$this->cell(180,05,$totalmbr1." Décés",1,1,1,'C',0);				 
	...
	function MEDICOLEGALES($titre,$datejour1,$datejour2,$EPH1,$STRUCTURED) 
	{
	$this->SetFont('Times', 'B', 11);
	$this->SetXY(5,10);$this->cell(200,5,$this->repfr,0,0,'C',1,0);
	$this->SetXY(5,20);$this->cell(200,5,$this->mspfr,0,0,'C',1,0);
	...
	$this->cell(10,10,"Sexe",1,0,'C',1,0);
	$this->cell(20,10,"Date décès",1,0,1,'C',0);
	$this->cell(60,10,"Circonstance de la mort  ",1,0,'C',1,0);
	$this->cell(60,10,"Cause médicolégale",1,0,'C',1,0);
	$this->cell(30,10,"Observations",1,0,'C',1,0);
	
	$this->mysqlconnect();
    $query = "SELECT * FROM deceshosp  where CD ='CI' and STRUCTURED $EPH1 and DINS BETWEEN '$datejour1' AND '$datejour2' order by  DINS ";    
	$resultat=mysql_query($query);
	$totalmbr1=mysql_num_rows($resultat);
	$this->SetFont('Arial','',9,'',true);
	$this->SetXY(05,$this->GetY()+10);
	$x=0;
		while($row=mysql_fetch_object($resultat))
		{
			...
			$this->cell(10,5,trim($row->SEX),1,0,'C',0);
			$this->cell(20,5,$this->dateUS2FR($row->DINS),1,0,'C',0);
			$this->cell(60,5,trim($row->NOM).'_'.strtolower (trim($row->PRENOM)).' ['.strtolower (trim($row->FILSDE)).']',1,0,'L',0);
			$this->cell(60,5,$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_cod'),1,0,'L',0);
			//$this->cell(60,5,'('.$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_nom').')_'.$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_cod'),1,0,'L',0);
			$this->cell(30,5,'',1,0,'C',0);
		    $this->SetXY(5,$this->GetY()+5);
	    }
	
	$this->SetFont('Arial', '',10, '', true);
	$this->SetXY(5,$this->GetY());$this->cell(50,05,"TOTAL",1,0,1,'C',0);$this->cell(150,05,$totalmbr1." Deces",1,1,1,'C',0);
	}
	
	
	
	function MORTALITEMATERNELLE($titre,$datejour1,$datejour2,$EPH1,$STRUCTURED) 
	{
	$this->SetFont('Times', 'B', 11);
	$this->SetXY(5,10);$this->cell(200,5,$this->repfr,0,0,'C',1,0);
	$this->SetXY(5,20);$this->cell(200,5,$this->mspfr,0,0,'C',1,0);
	...
	$this->cell(10,10,"Sexe",1,0,'C',1,0);
	$this->cell(20,10,"Date décès",1,0,1,'C',0);
	$this->cell(60,10,"Nom et Prenom fille de   ",1,0,'C',1,0);
	$this->cell(60,10,"Cause du déces ",1,0,'C',1,0);
	$this->cell(30,10,"Observations",1,0,'C',1,0);
	$age1=15;$age2=45;
	$this->mysqlconnect();
    $query = "SELECT * FROM deceshosp  where SEX= 'F' and STRUCTURED $EPH1 and (DINS BETWEEN '$datejour1' AND '$datejour2') and (Years BETWEEN '$age1' AND '$age2')    order by  DINS ";    
	$resultat=mysql_query($query);
	$totalmbr1=mysql_num_rows($resultat);
	$this->SetFont('Arial','',9,'',true);
	$this->SetXY(05,$this->GetY()+10);
	$x=0;
		while($row=mysql_fetch_object($resultat))
		{
			...
			$this->cell(10,5,trim($row->SEX),1,0,'C',0);
			$this->cell(20,5,$this->dateUS2FR($row->DINS),1,0,'C',0);
			$this->cell(60,5,strtoupper (trim($row->NOM)).'_'.strtolower (trim($row->PRENOM)).' ['.strtolower (trim($row->FILSDE)).']',1,0,'L',0);
			$this->cell(60,5,$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_cod'),1,0,'L',0);
			//$this->cell(60,5,'('.$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_nom').')_'.$this->nbrtostring("CIM","row_id",$row->CODECIM,'diag_cod'),1,0,'L',0);
			$this->cell(30,5,'',1,0,'C',0);
		    $this->SetXY(5,$this->GetY()+5);
    ...
    {
	//$this->Image('../public/IMAGES/photos/pc.gif',250,50,30,30,0);
	$this->SetXY(90,40);$this->cell(65,5,'WILAYA DE DJELFA',1,0,'C',1,0);
