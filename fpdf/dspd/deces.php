...
{ 
	...
	function ctrldate($Datedebut,$Datefin)
	{	
		if (!isset($Datedebut)||!isset($Datefin))
		{
			$this->datejour1 = date("Y-m-d");
			$this->datejour2 = date("Y-m-d");
		}
		else
		{
			...
			{ 
			 $this->datejour1 = $this->dateFR2US($Datedebut);
			 $this->datejour2 = $this->dateFR2US($Datefin);
			}
		}
	if (($this->datejour1 > $this->datejour2) || ($this->datejour1 == $this->datejour2)){header("Location: ../../dspd/Evaluation");}
	...
	{
	$this->mysqlconnect();
	$sql = " select * from deceshosp  where DINS BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' AND SEX $SEX";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function valeurpm($ANNEE) 
	{ 
		$SEXM='='.'"M"';$SEXF='='.'"F"';$SEX='IS NOT NULL';
		
		$Janm = $this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$SEXM);$Janf = $this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$SEXF);$Jan =$this->valeur($ANNEE."-01-01",$ANNEE."-01-31",$SEX);
		$Fevm = $this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$SEXM);$Fevf = $this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$SEXF);$Fev =$this->valeur($ANNEE."-02-01",$ANNEE."-02-29",$SEX);
		$Marm = $this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$SEXM);$Marf = $this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$SEXF);$Mar =$this->valeur($ANNEE."-03-01",$ANNEE."-03-31",$SEX);
		$Avrm = $this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$SEXM);$Avrf = $this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$SEXF);$Avr =$this->valeur($ANNEE."-04-01",$ANNEE."-04-30",$SEX);
		$Maim = $this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$SEXM);$Maif = $this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$SEXF);$Mai =$this->valeur($ANNEE."-05-01",$ANNEE."-05-31",$SEX);
		$Juim = $this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$SEXM);$Juif = $this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$SEXF);$Jui =$this->valeur($ANNEE."-06-01",$ANNEE."-06-30",$SEX);
		$Juilm= $this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$SEXM);$Juilf= $this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$SEXF);$Juil=$this->valeur($ANNEE."-07-01",$ANNEE."-07-31",$SEX);
		$Aoum = $this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$SEXM);$Aouf = $this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$SEXF);$Aou =$this->valeur($ANNEE."-08-01",$ANNEE."-08-31",$SEX);
		$Sepm = $this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$SEXM);$Sepf = $this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$SEXF);$Sep =$this->valeur($ANNEE."-09-01",$ANNEE."-09-30",$SEX);
		$Octm = $this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$SEXM);$Octf = $this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$SEXF);$Oct =$this->valeur($ANNEE."-10-01",$ANNEE."-10-31",$SEX);
		$Novm = $this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$SEXM);$Novf = $this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$SEXF);$Nov =$this->valeur($ANNEE."-11-01",$ANNEE."-11-30",$SEX);
		$Decm = $this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$SEXM);$Decf = $this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$SEXF);$Dec =$this->valeur($ANNEE."-12-01",$ANNEE."-12-31",$SEX);
		$totm = $this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$SEXM);$totf = $this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$SEXF);$tot =$this->valeur($ANNEE."-01-01",$ANNEE."-12-31",$SEX);
		
		if($tot>0) {$totx=$tot;} else {$totx=0.001;}	
		$PJan =round(($Jan*100)/$totx,2);
		$PFev =round(($Fev*100)/$totx,2); 
		$PMar =round(($Mar*100)/$totx,2);
		$PAvr =round(($Avr*100)/$totx,2); 
		$PMai =round(($Mai*100)/$totx,2); 
		$PJui =round(($Jui*100)/$totx,2); 
		$PJuil=round(($Juil*100)/$totx,2);
		$PAou =round(($Aou*100)/$totx,2); 
		$PSep =round(($Sep*100)/$totx,2); 
		$POct =round(($Oct*100)/$totx,2);
		$PNov =round(($Nov*100)/$totx,2);
		$PDec =round(($Dec*100)/$totx,2);
		$Ptot =round(($tot*100)/$totx,2);
		
		$this->RoundedRect(105,$this->GetY()+15,100,12*5, 2, $style = '');
		$this->SetXY(5,$this->GetY()+10);$this->cell(20,5,"Année ".$ANNEE,1,0,'C',1,0);$this->cell(20,5,"M",1,0,'C',1,0);  $this->cell(20,5,"F",1,0,'C',1,0); $this->cell(20,5,"T",1,0,'C',1,0); $this->cell(15,5,"P%",1,0,'C',1,0);$this->SetXY($this->GetX()+5,$this->GetY());$this->cell(100,5,"",1,0,'L',1,0);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Jan",1,0,'C',1,0); $this->cell(20,5,$Janm ,1,0,'C',0,0); $this->cell(20,5,$Janf ,1,0,'C',0,0); $this->cell(20,5,$Jan ,1,0,'C',1,0); $this->cell(15,5,$PJan ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Jan!=0){$this->cell($PJan,5,$PJan ,1,0,'L',1,0);}else {$this->cell(0.19,5,$Jan ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Fev",1,0,'C',1,0); $this->cell(20,5,$Fevm ,1,0,'C',0,0); $this->cell(20,5,$Fevf,1,0,'C',0,0);  $this->cell(20,5,$Fev,1,0,'C',1,0);  $this->cell(15,5,$PFev,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Fev!=0){$this->cell($PFev,5,$PFev ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Fev ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Mar",1,0,'C',1,0); $this->cell(20,5,$Marm ,1,0,'C',0,0); $this->cell(20,5,$Marf ,1,0,'C',0,0); $this->cell(20,5,$Mar,1,0,'C',1,0);  $this->cell(15,5,$PMar,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Mar!=0){$this->cell($PMar,5,$PMar ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Mar ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Avr",1,0,'C',1,0); $this->cell(20,5,$Avrm ,1,0,'C',0,0); $this->cell(20,5,$Avrf ,1,0,'C',0,0); $this->cell(20,5,$Avr ,1,0,'C',1,0); $this->cell(15,5,$PAvr ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Avr!=0){$this->cell($PAvr,5,$PAvr ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Avr ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Mai",1,0,'C',1,0); $this->cell(20,5,$Maim ,1,0,'C',0,0); $this->cell(20,5,$Maif ,1,0,'C',0,0); $this->cell(20,5,$Mai ,1,0,'C',1,0); $this->cell(15,5,$PMai ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Mai!=0){$this->cell($PMai,5,$PMai ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Mai ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Jui",1,0,'C',1,0); $this->cell(20,5,$Juim ,1,0,'C',0,0); $this->cell(20,5,$Juif ,1,0,'C',0,0); $this->cell(20,5,$Jui ,1,0,'C',1,0); $this->cell(15,5,$PJui ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Jui!=0){$this->cell($PJui,5,$PJui ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Jui ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Jui",1,0,'C',1,0); $this->cell(20,5,$Juilm ,1,0,'C',0,0);$this->cell(20,5,$Juilf ,1,0,'C',0,0);$this->cell(20,5,$Juil ,1,0,'C',1,0);$this->cell(15,5,$PJuil ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Juil!=0){$this->cell($PJuil,5,$PJuil ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Juil ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Aou",1,0,'C',1,0); $this->cell(20,5,$Aoum ,1,0,'C',0,0); $this->cell(20,5,$Aouf ,1,0,'C',0,0); $this->cell(20,5,$Aou,1,0,'C',1,0);  $this->cell(15,5,$PAou,1,0,'C',1,0); $this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Aou!=0){$this->cell($PAou,5,$PAou,1,0,'L',1,0);}else{$this->cell(0.19,5,$Aou,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Sep",1,0,'C',1,0); $this->cell(20,5,$Sepm ,1,0,'C',0,0); $this->cell(20,5,$Sepf ,1,0,'C',0,0); $this->cell(20,5,$Sep ,1,0,'C',1,0); $this->cell(15,5,$PSep ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Sep!=0){$this->cell($PSep,5,$PSep ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Sep ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Oct",1,0,'C',1,0); $this->cell(20,5,$Octm ,1,0,'C',0,0); $this->cell(20,5,$Octf ,1,0,'C',0,0); $this->cell(20,5,$Oct ,1,0,'C',1,0); $this->cell(15,5,$POct ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Sep!=0){$this->cell($POct,5,$POct ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Oct ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Nov",1,0,'C',1,0); $this->cell(20,5,$Novm ,1,0,'C',0,0);$this->cell(20,5,$Novf ,1,0,'C',0,0);  $this->cell(20,5,$Nov ,1,0,'C',1,0); $this->cell(15,5,$PNov ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Nov!=0){$this->cell($PNov,5,$PNov ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Nov ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Dec",1,0,'C',1,0); $this->cell(20,5,$Decm ,1,0,'C',0,0);$this->cell(20,5,$Decf ,1,0,'C',0,0);  $this->cell(20,5,$Dec ,1,0,'C',1,0); $this->cell(15,5,$PDec ,1,0,'C',1,0);$this->SetFillColor(120,255,120); $this->SetXY($this->GetX()+5,$this->GetY());if($Dec!=0){$this->cell($PDec,5,$PDec ,1,0,'L',1,0);}else{$this->cell(0.19,5,$Dec ,1,0,'L',1,0);}$this->SetFillColor(230);
		$this->SetXY(5,$this->GetY()+5);$this->cell(20,5,"Année ".$ANNEE,1,0,'C',1,0); $this->cell(20,5,$totm ,1,0,'C',0,0);$this->cell(20,5,$totf ,1,0,'C',0,0);$this->cell(20,5,$tot ,1,0,'C',1,0);$this->cell(15,5,$Ptot ,1,0,'C',1,0);$this->SetXY($this->GetX()+5,$this->GetY());$this->cell(10,5,"10",1,0,'L',1,0);$this->cell(10,5,"20",1,0,'L',1,0);$this->cell(10,5,"30",1,0,'L',1,0);$this->cell(10,5,"40",1,0,'L',1,0);$this->cell(10,5,"50",1,0,'L',1,0);$this->cell(10,5,"60",1,0,'L',1,0);$this->cell(10,5,"70",1,0,'L',1,0);$this->cell(10,5,"80",1,0,'L',1,0);$this->cell(10,5,"90",1,0,'L',1,0);$this->cell(10,5,"100",1,0,'L',1,0);
	}	
	...
	function dspnbr($datejour1,$datejour2,$STRUCTURED,$sexe)
	{
	$this->mysqlconnect();
	$sql = " select * from deceshosp where (DINS BETWEEN '$datejour1' AND '$datejour2') and ( STRUCTURED  $STRUCTURED ) and SEX $sexe ";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	...
	function dspaprouve($datejour1,$datejour2,$STRUCTURED,$aprouve)
	{
	$this->mysqlconnect();
	$sql = " select * from deceshosp where (DINS BETWEEN '$datejour1' AND '$datejour2') and ( STRUCTURED  $STRUCTURED ) and aprouve $aprouve ";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$collecte=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $collecte;
	}
	function INFORMATIONM($datejour1,$datejour2,$col)
	{
		$queryim= "SELECT * FROM deceshosp where $col='' and  DINS BETWEEN '$datejour1' AND '$datejour2' order by  DINS  ";//
		...
		if ($totalmbrim>0) 
		{
			...
			$this->SetXY(5,$this->GetY()+10);$this->cell(290,5,$this->mspfr,0,0,'C',1,0);
			$this->SetXY(5,$this->GetY()+10);$this->cell(290,5,$this->dspfr.': Djelfa ',0,0,'C',1,0);
		    $this->SetXY(5,$this->GetY()+15);$this->cell(90,5,"Service Prévention",0,0,'L',0,0);$this->SetXY(205,$this->GetY());$this->cell(90,5," LE : ".date('d-m-Y'),0,0,'C',0,0);$this->SetXY(5,$this->GetY()+5);$this->cell(90,5,"N ____ / ".date('Y'),0,0,'L',0,0);
			...
			$this->cell(180,10,"Nom_Prénom",1,0,'C',1,0);
			$this->cell(75,10,"Etablissement",1,0,'C',1,0);
			...
			$this->cell(180,5,trim($rowim->NOM).'_'.strtolower (trim($rowim->PRENOM)).' ['.strtolower (trim($rowim->FILSDE)).']',1,0,'L',0);
			$this->cell(75,5,$this->nbrtostring("structure","id",$rowim->STRUCTURED,"structure"),1,0,'L',0);
	...
	function AGESEXEKC($colone1,$colone2,$colone3,$datejour1,$datejour2,$SEXEDNR,$STRUCTURED){$this->mysqlconnect();$sql = " select * from deceshosp where CODECIM0= '02' AND  ($colone1 >=$colone2  and $colone1 <=$colone3)  and (DINS BETWEEN '$datejour1' AND '$datejour2') and (SEX='$SEXEDNR' and STRUCTURED $STRUCTURED )";$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());$collecte=mysql_num_rows($requete);mysql_free_result($requete);return $collecte;}
	function T2F20KC($datejour1,$datejour2,$EPH1,$tages)  
    {
	$this->SetFont('Times', 'B', 10);$this->SetTextColor(0,0,0);$this->SetFillColor(230); 
	$mr = array();$fr = array();$mfrp = array();
	for ($i = 0; $i <= $tages; $i+= 5) {$mr[$i]=$this->AGESEXEKC("years",$i,$i+4,$datejour1,$datejour2,'M',$EPH1);$fr[$i]=$this->AGESEXEKC("years",$i,$i+4,$datejour1,$datejour2,'F',$EPH1);}
	$mf=array_sum($mr)+array_sum($fr);
	$this->SetXY(5,25+10);$this->cell(285,5,"Cette étude a porté sur ".$mf." décès survenus durant la periode du ".$this->dateUS2FR($datejour1)." au ".$this->dateUS2FR($datejour2)." au niveau de 36 communes ",0,0,'L',0);
	$this->SetXY(5,42);                 $this->cell(200,05,"Repartition des décès par tranche d'age et sexe (global)",1,0,'L',1,0);
	$this->SetXY(5,$this->GetY()+5);    $this->cell(15,15,"Age",1,0,'C',1,0);
	...
	for ($i = 0; $i <= $tages; $i+= 5) 
	{
		$m=$this->AGESEXEKC("years",$i,$i+4,$datejour1,$datejour2,'M',$EPH1);
		$f=$this->AGESEXEKC("years",$i,$i+4,$datejour1,$datejour2,'F',$EPH1);
		if($mf>0){$mfp=round(((($m+$f)*100)/$mf),2);$mfrp[$i]=round(((($m+$f)*100)/$mf),2);} else {$mfp=0;$mfrp[$i]=0;}
		$this->SetXY(5,$this->GetY()+5);
		$this->cell(15,5,$i."-".($i+4),1,0,'C',1,0);
		$this->cell(25,5,$m,1,0,'C',0,0); 
	...
	$this->mysqlconnect();
	$query="SELECT * FROM com where IDWIL ='17000' and yes='1' order by COMMUNE "; //    % %will search form 0-9,a-z            
	...
	function DECESMATERNELS($titre,$datejour1,$datejour2,$STRUCTURED) 
	{
	$this->SetFont('Times', 'B', 11);
	...
	$this->SetFont('Times', 'B', 11);
	$this->SetFillColor(200 );
	$this->SetXY(5,38);$this->cell(195,10,$titre,0,0,'C',0);
	$this->SetXY(05,$h);
	...
	function MEDICOLEGALES($titre,$datejour1,$datejour2,$EPH1) 
	{
	$this->SetFont('Times', 'B', 11);
	$this->SetXY(5,10);$this->cell(200,5,$this->repfr,0,0,'C',1,0);
	$this->SetXY(5,20);$this->cell(200,5,$this->mspfr,0,0,'C',1,0);
	...
	$datey = explode('-', $datejour2);$date=$datey[0];
	$this->SetXY(5,38);$this->cell(195,10,$titre." ( Annee : ".$date." )",0,0,'C',0);
	$y=50;
	$this->SetFillColor(200 );
	$this->SetXY(05,$this->GetY()+10);
	$this->cell(10,10,"N°",1,0,'C',1,0);
	...
	function MORTALITEMATERNELLE($titre,$datejour1,$datejour2,$EPH1) 
	{
	$this->SetFont('Times', 'B', 11);
	$this->SetXY(5,10);$this->cell(200,5,$this->repfr,0,0,'C',1,0);
	$this->SetXY(5,20);$this->cell(200,5,$this->mspfr,0,0,'C',1,0);
	...
	function MORTALITEKC($titre,$datejour1,$datejour2,$EPH1) 
	{
	$this->SetFont('Times', 'B', 11);
	$this->SetXY(5,10);$this->cell(200,5,$this->repfr,0,0,'C',1,0);
	$this->SetXY(5,20);$this->cell(200,5,$this->mspfr,0,0,'C',1,0);
	...
	$age1=15;$age2=45;
	$this->mysqlconnect();
    $query = "SELECT * FROM deceshosp  where CODECIM0= '02' and STRUCTURED $EPH1 and (DINS BETWEEN '$datejour1' AND '$datejour2') order by  DINS ";    
	$resultat=mysql_query($query);
	$totalmbr1=mysql_num_rows($resultat);
	$this->SetFont('Arial','',9,'',true);
	$this->SetXY(05,$this->GetY()+10);
	...
	function AGESEXEMMX($colone1,$colone2,$colone3,$datejour1,$datejour2,$STRUCTURED){$this->mysqlconnect();$sql = " select * from deceshosp where  ($colone1 >=$colone2  and $colone1 <=$colone3)  and (DINS BETWEEN '$datejour1' AND '$datejour2') and (SEX='F' and STRUCTURED $STRUCTURED )    ";$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());$collecte=mysql_num_rows($requete);mysql_free_result($requete);return $collecte;}
	function dataMMX($x,$y,$colone1,$TABLE,$DINS,$COMMUNER,$datejour1,$datejour2,$STRUCTURED) 
	{
	$T2F20=array(
	"xt" => $x,
	"yt" => $y,
	...
	"tc3" =>"F",
	"tc5" =>"Total",
	"1MM"  => $this->AGESEXEMMX($colone1,15,19,$datejour1,$datejour2,$STRUCTURED), 
	"2MM"  => $this->AGESEXEMMX($colone1,20,24,$datejour1,$datejour2,$STRUCTURED), 
	"3MM"  => $this->AGESEXEMMX($colone1,25,29,$datejour1,$datejour2,$STRUCTURED), 
	"4MM"  => $this->AGESEXEMMX($colone1,30,34,$datejour1,$datejour2,$STRUCTURED),  
	"5MM"  => $this->AGESEXEMMX($colone1,35,39,$datejour1,$datejour2,$STRUCTURED), 			
	"6MM"  => $this->AGESEXEMMX($colone1,40,44,$datejour1,$datejour2,$STRUCTURED), 					
	"7MM"  => $this->AGESEXEMMX($colone1,45,49,$datejour1,$datejour2,$STRUCTURED), 
	"T" =>'1',
	"tl" =>"Age",
	"1MF"  => '15-19',  
	"2MF"  => '20-24',   
